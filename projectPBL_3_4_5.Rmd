...
pwr.t.test(power = NULL, n=3, sig.level = 0.01, type = "two.sample", d = differenceMean)

# calculates n needed for power of 0.8
pwr.t.test(power = 0.8, n = NULL,  sig.level = 0.01, type = "two.sample", d = differenceMean)
```
As shown in the previous code chunk, the power when comparing two conditions of our data is only ca. 0.041 . If we want a power over 0.8 we would need 24 samples for each condition.
