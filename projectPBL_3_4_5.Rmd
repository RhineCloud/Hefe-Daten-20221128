...
# meant to do a scatter matrix, but did not work (yet)
# library(GGally)

# summarizedReplicates %>%
#   filter(heatshock_of_interest.gene_id == "YGL073W" ||
#          heatshock_of_interest.gene_id == "YMR037C" ||
#          heatshock_of_interest.gene_id == "YKL062W") %>%
#   ggpairs()
```
